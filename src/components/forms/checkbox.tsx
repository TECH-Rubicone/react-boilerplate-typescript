...
const FCheckbox: React.FC<FCheckboxProps> = props => {
  const {
    options, label, skipTouch, name, fullWidth, required,
    prepareFormValue, getOptionLabel, getOptionValue, ...attr
  } = props;
  ...
  return <FormControl required={required} fullWidth={fullWidth} component="fieldset" variant="standard">
